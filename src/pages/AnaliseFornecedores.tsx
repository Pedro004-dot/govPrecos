    ...
    <div className="space-y-10 w-full">
      ...
      <div className="animate-dash-in" style={{ animationDelay: '0ms' }}>
        ...
        <p className="mt-2 text-sm text-muted-foreground max-w-sm leading-relaxed">
          Inteligência de mercado sobre fornecedores participantes em licitações PNCP.
        </p>
      ...
      >
        <div className="relative mb-6">
          ...
          <div className="absolute -top-1 -right-1 flex h-5 w-5 items-center justify-center rounded-full bg-primary/15">
        ...
        <p className="text-sm text-muted-foreground/60 max-w-xs leading-relaxed">
          Esta tela será implementada em breve. Aqui você terá análise
          detalhada de fornecedores e histórico de participações.
        </p>
